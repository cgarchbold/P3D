...
parser.add_argument('--save-dir', type=str, default='./plots', help='path to save the t-sne image')
...
dataset = ProtestDataset(
                        txt_file = os.path.join('/scratch/UCLA-processed/', 'annot_train.txt'),
                        img_dir = os.path.join('/scratch/UCLA-processed/', 'img', 'train'),
                        transform = transform)
